...
public class WastelandConfig {
    ...
    public static final ForgeConfigSpec.BooleanValue MUTATION_PARTICLES;
    public static final ForgeConfigSpec.DoubleValue PARTICLE_RANGE;
    ...
    public static final ForgeConfigSpec.DoubleValue DANGER_RANGE;
