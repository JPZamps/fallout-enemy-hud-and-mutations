...
public class WastelandConfig {
    ...
    public static final ModConfigSpec.BooleanValue BOSS_SPOILS_ENABLED;
    public static final ModConfigSpec.BooleanValue END_SPOILS_ENABLED;
    public static final ModConfigSpec.DoubleValue END_SPOILS_CHANCE;
    public static final ModConfigSpec.DoubleValue END_SPOILS_BOSS_CHANCE;
    public static final ModConfigSpec.ConfigValue<List<? extends String>> END_SPOILS_ITEMS;
